...
{
    /// <summary>
    /// Extensions for NativeEventStream.
    /// </summary>
    public static unsafe class NativeEventStreamEx
    {
        ...
        /// <summary>
        /// Allocate a chunk of memory that can be larger than the max allocation size.
        /// </summary>
            ...
            where T : unmanaged
        {
            ...
            // NOTE: Write the remainder first as this helps avoid an extra allocation most of the time
        ...
        /// <summary> 
        /// Read a chunk of memory that could have been larger than the max allocation size.
        /// </summary>
